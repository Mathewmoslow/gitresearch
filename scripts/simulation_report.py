...
# Aggregate to weekly totals first
...
summary.to_csv(SIM_OUT / "simulation_results.csv", index=False)
print(f"✅ Saved simulation results to {SIM_OUT}/simulation_results.csv")
...
plt.tight_layout()
plt.savefig(SIM_OUT / "simulation_chart.png", dpi=300, bbox_inches='tight')
plt.close()

print(f"✅ Saved simulation chart to {SIM_OUT}/simulation_chart.png")
